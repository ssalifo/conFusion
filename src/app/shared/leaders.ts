...
export const LEADERS: Leader[] = [
  {
    ...
    description:
      ...
      inspiration to create the fusion cuisines for which The Frying Pan \
      became well known. He brings his zeal for fusion cuisines to this restaurant, pioneering cross-cultural culinary connections."
  },
  {
    id: "1",
  ...
  },
  {
    ...
    description:
      ...
      ensures that every dish that we serve meets his exacting tastes. Our chefs dread\
       ...
       standards. He lives by his motto, You click only if you survive my lick."
  },
  {
    id: "3",
    ...
    // tslint:disable-next-line:max-line-length
    description:
      "Award winning three-star Michelin chef with wide International experience\
       having worked closely with whos-who in the culinary world, he specializes\
        in creating mouthwatering Indo-Italian fusion experiences. He says, Put \
